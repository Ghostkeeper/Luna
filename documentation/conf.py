...
"""
Defines the configuration for Sphinx.

Most of this is generated by Sphinx' quickstart tool. The rest is modified to
...
#.htaccess) here, relative to this directory. These files are copied directly
...
#class]).
latex_documents = [(master_doc, "Luna.tex", "Luna Documentation", "Ghostkeeper", "manual")]
...
texinfo_documents = [(master_doc, "Luna", "Luna Documentation", author, "Luna", "Conversion application.", "Miscellaneous")]
